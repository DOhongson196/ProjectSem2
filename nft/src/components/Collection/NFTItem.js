...
function NFTItem() {
  return (
    <div className="cursor-pointer w-72 group h-96  shadow-lg ease-in-out rounded-lg duration-300 hover:translate-y-[-4px] hover:shadow-xl overflow-hidden">
      {/* background image */}
      ...
      {/* content */}
      <div className="relative group-hover:-mt-11 bg-white dark:bg-bgDarkMode flex flex-col p-4 overflow-hidden z-10 transition-all ease-linear duration-200">
