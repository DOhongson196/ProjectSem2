...
export const FireIcon = ({ width = '1rem', height = '1rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const CheckIcon = ({ width = '1rem', height = '1rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const CheckIconL = ({ width = '1.2rem', height = '1.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const DarkIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 group">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M17.715 15.15A6.5 6.5 0 0 1 9 6.035C6.106 6.922 4 9.645 4 12.867c0 3.94 3.153 7.136 7.042 7.136 3.101 0 5.734-2.032 6.673-4.853Z"
      className="fill-[#1E2329] group-hover:fill-[#c99400]  "
    ></path>
    <path
...
export const LightIcon = () => (
  ...
  >
    <path
      ...
      className="fill-[#eaecef] stroke-[#eaecef] group-hover:fill-[#c99400] group-hover:stroke-[#c99400]"
    ></path>
    <path
      d="M12 4v1M17.66 6.344l-.828.828M20.005 12.004h-1M17.66 17.664l-.828-.828M12 20.01V19M6.34 17.664l.835-.836M3.995 12.004h1.01M6 6l.835.836"
      className="stroke-[#eaecef] group-hover:stroke-[#c99400]"
    ></path>
  </svg>
);

export const MailIcon = ({ width = '1.2rem', height = '1.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
